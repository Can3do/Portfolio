...
const Navigation = () => {
	...
	return (
		<header
			className={`sticky left-0 right-0 top-0 min-h-[4rem] box-border flex items-stretch justify-center bg-zinc-950/70  z-50 backdrop-blur-lg`}
		>
			<div
				className={`flex w-full max-w-7xl items-center px-6 md:px-16  `}
			>
				{/* Burger Menu */}

				<button
					className={`${styles.button} relative z-50 sm:hidden`}
