...
const HomePage = () => {
	return (
		<main className='flex flex-col items-center'>
			<section
				id='home'
				className='box-border flex w-full max-w-7xl px-6 py-8 sm:px-16 sm:py-12'
			>
			...
			<section className='box-border flex w-full max-w-7xl px-6 py-8 sm:px-16 sm:py-12'>
				<div className='flex flex-col gap-4'>
					<p>Introducción</p>
					<h2 className='text-4xl font-bold'>Un primer vistazo</h2>
				</div>
			</section>
		</main>
	);
